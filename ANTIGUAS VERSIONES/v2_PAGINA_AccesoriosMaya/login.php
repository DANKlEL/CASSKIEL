...
<div class="auth-container">
    <div class="auth-box">
        ...
        <form onsubmit="event.preventDefault(); return false;">
            ...
            <button type="button" class="btn-auth" onclick="ejecutarLogin()">Entrar</button>
        </form>
        
        <p class="auth-footer">¿No tienes cuenta? <a href="registro.php">Regístrate gratis</a></p>
    </div>
</div>
...
function ejecutarLogin() {
    ...
    if (usuarioEncontrado) {
        // --- LOGIN EXITOSO ---
        // Guardamos los datos del usuario logueado en una nueva clave 'usuarioActivo'
