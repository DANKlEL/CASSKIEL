...
function showProducts(category) {
  ...
  if (category === "juguetes") {
    ...
    productsHTML = `
      <div class="product">
        <img src="img/imagen6.jpg" alt="Chaleco para perro" />
        <p>Chaleco - $200</p>
        <button onclick="addToCart('Chaleco para perro', 200)">Añadir al carrito</button>
      </div>
      <div class="product">
        <img src="img/imagen11.jpg" alt="Croquetas para perro" />
