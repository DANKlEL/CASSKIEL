                ...
                <div class="cart-container-dropdown">
                    ...
                    <div class="cart-dropdown-panel">
                        ...
                        <div style="display:flex; justify-content:space-between; font-weight:bold; margin-bottom:15px;">
                            <span>Total:</span>
                            <span style="color:#ff914d;">$<span id="cart-total-price">0.00</span></span>
                        </div>
...
.btn-buy-mini { display: block; background: #ff914d; color: white !important; text-align: center; padding: 10px; border-radius: 10px; text-decoration: none; font-weight: bold; }
...
.btn-qty-mini:hover { background: #ff914d; color: white; }
            ...
            data.items.forEach(item => {
                ...
                <div class="mini-cart-item">
                    ...
                    <div style="flex-grow:1; font-size:0.85rem;">
                        ...
                        <div style="color:#ff914d; font-weight: bold;">$${item.precio}</div>
